      ...
      <div class="box-content">
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="gender" label="用户性别">
            <template slot-scope="scope">
              <p style="cursor: pointer">{{scope.row.gender===2 ? '女' : '男'}}</p>
            </template>
          </el-table-column>
          <el-table-column prop="sign" label="简介">
            <template slot-scope="scope">
              <p style="cursor: pointer">{{scope.row.sign}}</p>
            </template>
          </el-table-column>
...
import { userList,delUser } from "../api/index.js";
// import logo from "common/image/defaultLogo.png"
export default {
  data() {
    return {
      nickName: "",
      ...
      tableData: [],
      defaultAvatarUrl:
        "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1554561558196&di=94bae689d762a9d1f46ce44cf9f565e3&imgtype=0&src=http%3A%2F%2Fimage.bubuko.com%2Finfo%2F201706%2F20180110233539665928.png",
      isActive: false
    };
  },
  created() {
